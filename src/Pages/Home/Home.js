            ...
            <div className="flex text-center md:text-left my-3 items-center h-full">
              <div className="w-full h-max">
                ...
                <div className="mt-2 xl:mt-7">
                  ...
                  <button className="py-1 xl:py-2 px-2 xl:px-4 text-xs xl:text-2xl text-white font-semibold bg-[#EA9723] text-white relative overflow-hidden group z-10 hover:text-white duration-1000">
                    <span className="absolute bg-orange-400 w-36 h-36 rounded-full group-hover:scale-100 scale-0 -z-10 -left-2 -top-10 group-hover:duration-500 duration-700 origin-center transform transition-all"></span>
