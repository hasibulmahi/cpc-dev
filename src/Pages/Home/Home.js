            ...
            <div className="flex text-center md:text-left my-3 items-center h-full">
              <div className="w-full h-max">
                ...
                <div className="mt-2 xl:mt-7">
                  ...
                  <button className="py-1 xl:py-2 px-2 xl:px-4 text-xs xl:text-2xl font-semibold bg-[#EA9723] text-white relative overflow-hidden group z-10 hover:text-white duration-1000">
