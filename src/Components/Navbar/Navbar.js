  ...
  return (
    <>
      <div
        className={
          navAutoHide === "hide"
            ? "fixed bg-white dark:bg-slate-800 shadow-sm px-5 py-2 transition-[top] duration-300 w-full -top-20 z-[999]"
            : "fixed bg-white dark:bg-slate-800 shadow-sm px-5 py-2 transition-[top] duration-300 w-full top-0 z-[999]"
        }
      >
